...
#   1. extracts the top-metal view (Passiv, TopVia1, TopMetal1) from the
...
IMAGE_LAYERS = [
    ...
    ("125/0", "#b36b00", False, "fill"),     # TopVia1
    ("9/0",   "#ffffff", False, "fill"),     # Passiv
    ("126/0", "#ff9900", True, "fill"),      # TopMetal1
