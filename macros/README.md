...
4. `flow/librelane/config.yaml`: a `MACROS` entry with the view paths (`dir::../../macros/<NAME>/final/...`) and the instance placement. The placement of an analog macro snaps to the routing grid, see [doc/floorplan.md](../doc/floorplan.md).
